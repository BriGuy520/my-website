  ...
  return (
    <div className="technologies"> 
      ...
      <div className="skill-section">
        <div className="frontend-section">
          <div className="frontend-copy copy">
            <h1>Frontend</h1>
            <p>
              This is where I am the most confident. The main technologies that I use in my projects are HTML, CSS, Javascript with React and Redux as my "framework" of choice. While I have dabbled with other technologies such as Angular, I am not as confident with it as much as I am with React.
            </p>
            <ul>
              <li>HTML/CSS</li>
              <li>Javascript</li>
        ...
        <div className="backend-section">
          ...
          <div className="backend-copy copy">
            <h1>Backend</h1>
            <p>
              While I am not a backend expert by any stretch of the imagination, I really enjoy building out the backend. When building this site, I really came to apprectiate and enjoy solving the challenges that arise when trying to build a fullstack web application. Going forward, I really want to focus more on how to build scalable web applications using certain design principles and algorithms. 
            </p>
            <ul>
              <li>MongoDB</li>
              <li>NodeJS</li>
      ...
      <div className="distant-future-section copy">
        ...
        <p>
          This is going to take a while to learn since it involves having a deep understanding of computer science and mathematics. I have started working on improving these areas with <a href="https://brilliant.org">brilliant.org</a>, an excellent resource to touch up on these skills. 
        </p>
