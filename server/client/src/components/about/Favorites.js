  ...
  return (
    <div>
      ...
      <div className="lists">
        ...
        <div className="list-sections">
          <ol>
            <li><strong>Lateralus</strong> Tool</li>
            <li><strong>Cross</strong> Justice</li>
            <li><strong>Mezanine</strong> Massive Attack</li>
            <li><strong>Black on Both Sides</strong> Mos Def</li>
          </ol>
        </div>
      </div>
    </div>
